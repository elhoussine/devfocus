...
const seedAlgos = [
  ...
  },
  {
    ...
    textSolution:
      "Hash to get unique values in array, to check for duplicates.",
    difficulty: "Easy",
  },
  {
  ...
  },
  {
    ...
    textSolution:
      "Pattern: prev subarray can't be negative, dynamic programming: compute max sum for each prefix.",
    difficulty: "Easy",
  },
  {
    ...
    textSolution: "Dynamic Programming: compute max and max-abs-val for each prefix subarr.",
    difficulty: "Medium",
  },
  {
  ...
  },
  {
    ...
    textSolution:
      "Recursive: foreach num, get subseq with num and without num, only include num if prev was less, cache solution of each; Dynamic Programming: subseq length which must end with each num, curr num must be after a prev dp or by itself.",
    difficulty: "Medium",
  },
  {
  ...
  },
  {
    ...
    textSolution:
      "Can curr char be decoded in one or two ways? Recursion -> cache -> iterative dp solution, a lot of edge cases to determine, 52, 31, 29, 10, 20 only decoded one way, 11, 26 decoded two ways.",
    difficulty: "Medium",
  },
  {
    name: "Unique Paths",
  ...
  },
  {
    ...
    textSolution:
      "For each cell, if cell is 1 and unvisited run dfs, increment cound and marking each contigous 1 as visited.",
    difficulty: "Medium",
  },
  {
  ...
  },
  {
    ...
    textSolution:
      "Divide and conquer, merge lists, N totalnodes, k-lists, O(N*logk). For each list, find min val, insert it into list, use priorityQ to optimize finding min O(N*logk).",
    difficulty: "Hard",
  },
  {
  ...
  },
  {
    ...
    textSolution: "Hash to count each char in str1, decrement for str2.",
    difficulty: "Easy",
  },
  {
    name: "Group Anagrams",
  ...
  },
  {
    ...
    textSolution:
      "For each char in str, consider it were the middle, consider if pali was odd or even.",
    difficulty: "Medium",
  },
  {
  ...
  },
  {
    ...
    textSolution:
      "Min heap that’s kept at size k, if its bigger than k pop the min, by the end it should be left with k largest.",
    difficulty: "Medium",
  },
  {
